...
{
    bool operator()(const Edge* lhs, const Edge* rhs) const  { return lhs->get_weight() > rhs->get_weight(); }
};
...
public:
     ...
     */
    bool add_vertex(const int &id, double longitude, double latitude);
    ...
    */
    bool add_vertex(const int &id, string name);
    ...
    */
    bool add_edge(const int &source, const int &dest, double w) const;
    ...
    */
    ...
    /**
    * @brief This function prints the path ans the distance of the triangularApproximation approximation algorithm.
